...
public class ItemController {
    ...
    public ItemDto addItems(@Valid @RequestBody Item item, @RequestHeader(OWNER_ID) int ownerId) {

        return itemService.addItems(item, ownerId);
    }

    @PatchMapping("/{itemId}")  //updateItems Редактирование вещи
    public ItemDto updateItems(@PathVariable Integer itemId, @RequestBody Item item, @RequestHeader(OWNER_ID) int ownerId) {

        return itemService.itemDao.updateItems(itemId, item, ownerId);
    }
    ...
    public ItemDto getItemsById(@PathVariable Integer itemId) {
        ...
        return itemService.itemDao.getItemsById(itemId);
    }
    ...
    public List<ItemDto> getAllItemsOneUser(@RequestHeader(OWNER_ID) int ownerId) {
        ...
        return itemService.itemDao.getAllItemsOneUser(ownerId);
    }
